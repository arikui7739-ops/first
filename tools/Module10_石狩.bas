...
Sub CreateZoneRebalancePlan()
    ...
    Call AppendZonePairs(outRows, colX2AB, colAB2X, rMach, rDan, rCol, rCode, rName, rCnt, rZone, rForecast)
    Call AppendZonePairs(outRows, colX2C, colC2X, rMach, rDan, rCol, rCode, rName, rCnt, rZone, rForecast)
